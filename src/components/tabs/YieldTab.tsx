...
const PositionCard = ({ 
  ...
  return (
    <div className="bubble p-8">
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-muted-foreground px-3 py-1.5 rounded-full bg-muted/30">
              Fee: {fee}
            </span>
          </div>
        </div>
      ...
      {/* Yield Preference */}
      <div className="bg-primary/10 rounded-[20px] p-4 mb-6 border border-primary/20">
      ...
      <div className="bg-muted/20 rounded-[24px] p-6 mb-6 border border-bubble-border">
